...
namespace LMU_Final_Project_Web.Data.Repositories
{
    public class ServiceRepository
    {
        ...
        {
            string SqlString = $"insert into service (VehicleId,Service_center,Phone_no,Odometer_reading,Description,Date,Amount,Created_by,Created_on) values ('{service.Vehicle_Id}','{service.Service_center}','{service.Phone_no}','{service.Odometer_reading}','{service.Description}','{service.Date}','{service.Amount}','{service.Created_by}',GETDATE())";
